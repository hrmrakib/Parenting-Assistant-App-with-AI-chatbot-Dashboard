...
import { BookOpen, Check, UploadCloud, Edit, Trash2, ChevronDown } from "lucide-react"

const libraryData = [
  { id: 1, title: "Prenatal Yoga Basics", type: "Video", segment: "Week 12", created: "2025-10-01" },
  { id: 2, title: "Prenatal Yoga Basics", type: "Video", segment: "Week 12", created: "2025-10-01" },
  { id: 3, title: "Prenatal Yoga Basics", type: "Video", segment: "Week 12", created: "2025-10-01" },
  { id: 4, title: "Prenatal Yoga Basics", type: "Video", segment: "Week 12", created: "2025-10-01" },
]
      ...
      <div className="flex flex-col gap-6">
        ...
        <Card className="rounded-xl border-none shadow-[0_2px_8px_-4px_rgba(0,0,0,0.1)] p-8">
          <div className="flex items-start gap-3 mb-8">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 tracking-tight mb-1">Content Management</h2>
              <p className="text-sm text-gray-500">Upload, Edit, Delete and organize content by week or age group</p>
            </div>
          </div>

          <div className="mb-6">
            <h3 className="text-lg font-bold text-gray-900 tracking-tight">Add New Content</h3>
          ...
          <form className="space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <Button variant="dark" className="bg-[#1C1C1C] hover:bg-black rounded-lg h-10 px-5 flex items-center gap-2 text-sm font-medium">
                <Check className="h-4 w-4" />
                Save Content
              </Button>
              <Button variant="outline" className="rounded-lg h-10 px-5 flex items-center gap-2 text-sm font-medium bg-white text-gray-700 border-gray-200">
        ...
        <Card className="rounded-xl border-none shadow-[0_2px_8px_-4px_rgba(0,0,0,0.1)] p-8">
          <div className="mb-6">
            <h3 className="text-lg font-bold text-gray-900 tracking-tight">Library</h3>
            ...
            <table className="w-full text-left text-[14px]">
              <thead>
                <tr className="border-b-2 border-gray-100 text-gray-900 font-bold">
                  ...
                  <th className="pb-3 px-4 font-semibold text-center">Created</th>
              ...
              <tbody className="divide-y divide-gray-100 text-gray-600">
                {libraryData.map((item) => (
                  <tr key={item.id} className="hover:bg-gray-50/50 transition-colors">
                    <td className="py-4 px-4 font-medium text-gray-800">{item.title}</td>
