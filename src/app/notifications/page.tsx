        ...
        <div className='space-y-3 max-w-4xl'>
          {isLoading ? (
            ...
            notifications.map((notification: any, index: number) => {
              ...
              const levelStyle =
                LEVEL_STYLES[notification.level as keyof typeof LEVEL_STYLES] ??
                LEVEL_STYLES.INFO;
...
//                     notification.unread
//                       ? "border-white bg-white text-[#677761]"
...
//                   <p
//                     className={`text-[15px] font-medium ${notification.unread ? "text-white" : "text-gray-800"}`}
//                   >
//                     {notification.title}
//                   </p>
//                   <p
//                     className={`text-xs mt-1 ${notification.unread ? "text-white/80" : "text-gray-400"}`}
//                   >
//                     {notification.time}
//                   </p>
//                 </div>
